...
public class Position {
	 ...
	 */
	public int getLocalX_2(Position base) {
	 ...
	 */
	public int getLocalY_2(Position base) {
	 ...
	 * @return the local X coordinate
	 */
	public int getLocalX_2() {
		return getLocalX_2(this);
	}
	 ...
	 * @return the local Y coordinate.=
	 */
	public int getLocalY_2() {
		return getLocalY_2(this);
	}
