    ...
    public static boolean handleNest(Player player, int itemId){
        ...
        switch(itemId){
            case 5070:
                ...
                player.getInventory().addItemOrDrop(new Item(5076));
                player.getInventory().addItemOrDrop(new Item(5075));
                return true;
            case 5071:
                player.getInventory().removeItem(new Item(itemId));
                player.getInventory().addItemOrDrop(new Item(5078));
                player.getInventory().addItemOrDrop(new Item(5075));
                return true;
            case 5072:
                player.getInventory().removeItem(new Item(itemId));
                player.getInventory().addItemOrDrop(new Item(5077));
                player.getInventory().addItemOrDrop(new Item(5075));
                return true;
            case 5073:
        ...
        player.getInventory().removeItem(new Item(itemId));
        player.getInventory().addItemOrDrop(new Item(finalItem));
        player.getInventory().addItemOrDrop(new Item(5075));
        return true;
    }
