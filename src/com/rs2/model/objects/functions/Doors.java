...
public class Doors {
	...
	public static boolean handleDoor(Player player, int id, int x, int y, int z) {
		...
		if (id == 883 || id == 1805 || id == 2882 || id == 2883 || id == 2623 || id == 2112 || id == 1804 || id == 2266 || id == 2406 || id == 2407 || id == 2631 || id == 2623 || id == 8958 || id == 8959 || id == 8960 || id == 1589 || id == 1590 ||
				(id == 2155 && x == 2592 && y == 9490 || id == 2154 && x == 2593 && y == 9490)//mage guild basement gate
				) {
			return false;
		}
		...
		if(d.actionCount >= 5 && d.actuallyOpen){
			if(System.currentTimeMillis() - d.lastAction >= 10000){
				d.actionCount = 0;
			}else{
				player.getActionSender().sendMessage("The door is stuck open.");
				return true;
			}
		}
		...
		if (id == 22 || id == 2550 || id == 2551 || id == 2555 || id == 2556 || id == 2558 || id == 2557 || id == 3014) {
			d.doorId = id;
		...
		d.actuallyOpen = !d.actuallyOpen;
		if(System.currentTimeMillis() - d.lastAction < 1000){
			d.actionCount++;
		}else
			d.actionCount = 1;
		player.getActionSender().sendSound(318, 1, 0);
		d.lastAction = System.currentTimeMillis();
		return true;
	}
