...
public class DoubleDoors {
	...
	public static boolean handleDoubleDoor(int id, int x, int y, int z) {
		...
		if (!doorClicked.open) {
			if (doorClicked.originalFace == 0) {
				...
				DoubleDoors westDoor = null;
				DoubleDoors eastDoor = null;
				if(isWoodenGate(id)){
					westDoor = getDoor(x - 1, y, z);
					eastDoor = getDoor(x + 1, y, z);
				}
				if (lowerDoor != null) {
					...
					changeLeftDoor(doorClicked, false);
					changeRightDoor(westDoor, false);
				...
				DoubleDoors lowerDoor = null;
				DoubleDoors upperDoor = null;
				if(isWoodenGate(id)){
	...
	public static boolean isWoodenGate(int id) {
		for (int i = 0; i < woodenGate.length; i++) {
			if (id == woodenGate[i]) {
				return true;
			}
		}
	...
	private static int[] woodenGate = {1551, 1553, 1598, 1599, 2261, 2262, 2438, 2439, 2050, 2051, 3198, 3197, 3725, 3726, 7049, 7050, 8810, 8811, 12816, 12817, 12986, 12987};
