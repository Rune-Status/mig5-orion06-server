...
public enum SpecialType {
		...
		public WeaponAttack getSpecialAttack(final Player attacker, final Entity victim, Weapon weapon) {
			WeaponAttack weaponAttack = new WeaponAttack(attacker, victim, weapon) {
				...
				public boolean canInitialize() {
					...
					setHits(new HitDef[]{new HitDef(getAttackStyle(), HitType.NORMAL, maxDamage * 1.15).randomizeDamage().applyAccuracy(2.25), new HitDef(getAttackStyle(), HitType.NORMAL, maxDamage * 1.15).randomizeDamage().applyAccuracy(2.25)});
					return true;
				}
			};
			return weaponAttack;
		...
		public WeaponAttack getSpecialAttack(final Player attacker, final Entity victim, Weapon weapon) {
			final WeaponAttack weaponAttack = new WeaponAttack(attacker, victim, weapon) {
				...
				public boolean canInitialize() {
					...
					setHits(new HitDef[]{new HitDef(getAttackStyle(), HitType.NORMAL, maxDamage * 1.25).randomizeDamage().applyAccuracy(1.75)});
					return true;
				}
			};
			return weaponAttack;
	...
	public static void dbaxeSpec(Player player) {
		...
		player.getActionSender().sendSound(389, 1, 0);
	...
	public static void excaliburSpec(Player player) {
		...
		player.getActionSender().sendSound(384, 1, 0);
