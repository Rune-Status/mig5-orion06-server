...
public class ThieveStalls {
	...
	public enum Stall {
		...
		BREAD_STALL(new int[] { 2561, 6163, 630, 6569 }, new Item[] { new Item(2309), new Item(1891), new Item(1893), new Item(1895), new Item(1897), new Item(1899), new Item(1901) }, 5, 16, 8),
		CRAFTING_STALL(new int[] { 4874, 6166 }, new Item[] { new Item(1755), new Item(1621), new Item(1592), new Item(1597) }, 5, 16, 11),
		BANANA_STALL(new int[] { 4875 }, new Item[] { new Item(1963) }, 5, 16, 11),
		GENERAL_STALL(new int[] { 4876 }, new Item[] { new Item(1931), new Item(2347), new Item(590) }, 5, 16, 11),
		TEA_STALL(new int[] { 635, 6574 }, new Item[] { new Item(1978) }, 5, 16, 11),
		ROCK_CAKE_STALL(new int[] { 2793 }, new Item[] { new Item(2379) }, 15, 10, 10),
		SILK_STALL(new int[] { 2560, 6568, 629 }, new Item[] { new Item(950) }, 20, 24, 13),
		WINE_STALL(new int[] { 14011 }, new Item[] { new Item(1937), new Item(1993), new Item(1987), new Item(1935), new Item(7919)}, 22, 27, 26),
		SEED_STALL(new int[] { 7053 }, new Item[] { new Item(5307), new Item(5318), new Item(5096), new Item(5319), new Item(5305), new Item(5308), new Item(5310), new Item(5311), new Item(5324), new Item(5309), new Item(5306), new Item(5322), new Item(5320), new Item(5097), new Item(5098), new Item(5321), new Item(5323), new Item(5103)}, 27, 10, 30),
		FUR_STALL(new int[] { 2563, 4278, 632, 6571 }, new Item[] { new Item(958), new Item(948) }, 35, 36, 25),
		FISH_STALL(new int[] { 4277, 4705, 4707 }, new Item[] { new Item(331), new Item(359), new Item(377) }, 42, 14, 41),
		ORE_STALL(new int[] { 6164, 2565, 628 },  new Item[] { new Item(442) }, 50, 54, 50),
		SPICE_STALL(new int[] { 633, 2564, 6572 }, new Item[] { new Item(2007) }, 65, 81, 133),
		RUNE_STALL(new int[] { 4877 }, new Item[] { new Item(557), new Item(556), new Item(554), new Item(555), new Item(563)}, 65, 100, 133),
		SCIMITAR_STALL(new int[] { 4878 }, new Item[] { new Item(1325)}, 65, 100, 133),
	...
	public static boolean handleThievingStall(final Player player, final int objectId, final int objectX, final int objectY) {
		...
		player.setSkilling(new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				player.getInventory().addItemOrDrop(loot);
				...
				player.getActionSender().sendSound(358, 1, 0);
