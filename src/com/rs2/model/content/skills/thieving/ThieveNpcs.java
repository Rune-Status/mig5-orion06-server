...
public class ThieveNpcs {
	...
	public enum ThieveNpc {
		...
		MASTER_FARMER(new String[] { "master farmer"}, 38, 43, new Item[] { new Item(5101), new Item(5102), new Item(5103), new Item(5318), new Item(5319), new Item(5324), new Item(5322), new Item(5320), new Item(5323), new Item(5305), new Item(5307),
				...
				new Item(5291), new Item(5292), new Item(5293), new Item(5294)}, new Item[]{new Item(5321), new Item(5311), new Item(5295), new Item(5296), new Item(5282),
	...
	public static boolean handleThieveNpc(final Player player, final Npc npc) {
		...
		final boolean successful = Misc.random(player.getSkill().getLevel()[Skill.THIEVING])*3 > Misc.random(thieveNpc.getLevelReq()*2);
		final Item randomLoot = thieveNpc.getRareLoot() != null && Misc.random(30) == 0 ? thieveNpc.getRareLoot()[Misc.randomMinusOne(thieveNpc.getRareLoot().length)] : thieveNpc.getLoot()[Misc.randomMinusOne(thieveNpc.getLoot().length)];
		final Item loot = new Item(randomLoot.getId(), randomLoot.getCount());
		...
		CycleEventHandler.getInstance().addEvent(player, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				if (successful) {
					...
					player.getInventory().addItemOrDrop(new Item(loot.getId(), loot.getCount() * multiple(player, thieveNpc.getLevelReq())));
					...
					player.getActionSender().sendSound(458, 1, 0);
