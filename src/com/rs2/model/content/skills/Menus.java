...
public class Menus {
	...
	public static void display5ItemWTitle(Player player, int i1, int i2, int i3, int i4, int i5, String s1, String s2, String s3, String s4, String s5, String title) {
		...
		player.getActionSender().sendString(title, 8966);
