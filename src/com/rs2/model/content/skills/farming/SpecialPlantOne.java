...
public class SpecialPlantOne {
	...
	public enum SpecialPlantData {
		...
		SPIRIT_TREE(5375, -1, 1, 83, 3520, 0.15, 199.5, 0, 8, 20, 44, 19301.8, 12, 23), CALQUAT_TREE(5503, 5980, 1, 72, 1280, 0.15, 129.5, 48.5, 4, 18, 34, 12096, 14, 20);
	...
	public void doCalculations() {
		for (int i = 0; i < farmingSeeds.length; i++) {
			...
			if(specialPlantData == SpecialPlantData.CALQUAT_TREE){
				if(hasFullyGrown[i] && farmingStages[i] < 18){
					farmingStages[i]++;
				}
			}
	...
	public boolean harvestOrCheckHealth(int objectX, int objectY) {
		...
		player.setSkilling(new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				System.out.println("harv: "+farmingStages[specialPlantFieldsData.getSpecialPlantsIndex()]);
				updateSpecialPlants();
				container.stop();
			}
