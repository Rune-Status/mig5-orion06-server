...
public class DramenBranch {
	...
	public static enum DramenItem {
		STAFF(2799, 771, 772, 1, 1, 31, 0), STAFF5(2798, 771, 772, 5, 1, 31, 0), STAFF10(1747, 771, 772, 27, 1, 31, 0), STAFFX(1748, 771, 772, 0, 1, 31, 0);
		...
		if (player.getStatedInterface() == "dramenBranch") {
			...
			player.setSkilling(new CycleEvent() {
				...
				public void execute(CycleEventContainer container) {
					...
					player.getUpdateFlags().sendAnimation(LOG_CUTTING_ANIM);
					player.getActionSender().sendMessage("You carve the branch into a staff.");
