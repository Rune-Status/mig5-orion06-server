...
public class TwoIngredients {
	public static enum MixItemData {
		STEW(2142, 1942, 1921, 1999, 2001, 25, 117, true, 0, 0), STEW1(1942, 2142, 1921, 1997, 2001, 25, 117, true, 0, 0), STEW_CHICKEN(2140, 1942, 1921, 1999, 2001, 25, 117, true, 0, 0), STEW1_CHICKEN(1942, 2140, 1921, 1997, 2001, 25, 117, true, 0, 0), PLAIN_PIZZA(1982, 1985, 2283, 2285, 2287, 35, 143, true, 0, 0), TUNE_AND_CORN(361, 5988, 1923, 7086, 7068, 67, 204, true, 0, 0), TUNE_AND_CORN2(5988, 361, 1923, 7088, 7068, 67, 204, true, 0, 0),
	...
	public static boolean mixItems(Player player, int itemUsed, int withItem, int itemUsedSlot, int withItemSlot) {
		...
		player.getInventory().addItemOrDrop(new Item(result));
		player.getSkill().addExp(Skill.COOKING, rightData.getExperience());
		/* empty recipients */
		if (rightData.getEmptyOne() != 0 && rightData == firstIngredient)
			player.getInventory().addItemOrDrop(new Item(rightData.getEmptyOne()));
		if (rightData.getEmptyTwo() != 0 && rightData == firstStage)
			player.getInventory().addItemOrDrop(new Item(rightData.getEmptyTwo()));
		return true;
	}
}
