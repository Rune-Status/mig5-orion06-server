...
public class SearchScrolls {
	...
	public static enum SearchData {
		...
		CRATE10(new String[]{"Search the crates in Canifis"}, 2709, new Position(3509, 3497, 0), -1, 832, 1),
		...
		CRATE15(new String[]{"Search the crates in the ", "guard house of the northern ", "gate of East Ardougne."}, 2773, new Position(2645, 3338, 0), -1, 832, 1),
		CRATE16(new String[]{"Search the crates in the ", "northernmost house in Al ", "Kharid"}, 2774, new Position(3289, 3202, 0), -1, 832, 1),
		...
		CRATE22(new String[]{"A crate found in the", "tower of a church is", "your next location."}, 3494, new Position(2612, 3307, 2), -1, 832, 1),
		...
		CRATE24(new String[]{"Search the crates of", "Falador's general store"}, 2793, new Position(2955, 3390, 0), -1, 832, 1),
		...
		CRIPTICS17(new String[]{"This crate is mine, all ", "mine, even if it is in the ", "middle of the desert."}, 7272, new Position(3289, 3022, 0), 0, 832, 3),
		...
		CRIPTICS22(new String[]{"You have all of the elements", "available to solve this clue.", "Fortunately you do not have to", "go so far as to stand in a", "draft."}, 7268, new Position(2723, 9891, 0), 0, 832, 3),
		CRIPTICS23(new String[]{"Throat mage seeks ", "companionship. Seek ", "answers inside my ", "furniture if interested."}, 7254, new Position(2668, 3238, 1), 353, 832, 3),
		/* the clues that needs key */

		KEY_CRIPTICS0(new String[]{"Search the upstairs drawers ", "of a house in a village were ", "pirates are known to have a ", "good time."}, 3490, new Position(2809, 3165, 1), 349, 832, 2),
