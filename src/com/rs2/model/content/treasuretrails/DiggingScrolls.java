...
public class DiggingScrolls {
	...
	public static enum DigData {
		...
		DIG1(new String[]{"Dig near some giant mushrooms,", "behind the Grand Tree."}, 3618, new Position(2458, 3505), 1),
		...
		DIG3(new String[]{"As you desert this town,", "keep an eye out for a set of spines", "that could ruin nearby rugs:", "dig carefully around the greenery."}, 3609, new Position(3397, 2915), 3),
		...
		DIG5(new String[]{"Come to the @or2@evil ledge,", "@bla@Yew know yew want to.", "Try not to get stung."}, 7238, new Position(3089, 3468), 3),
		DIG6(new String[]{"Covered in shadows, the centre", "of the circle is where you will", "find the answer."}, 7252, new Position(3488, 3289), 3),
