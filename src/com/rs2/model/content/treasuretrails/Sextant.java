...
public class Sextant {
	...
	public static boolean everythingMatches(Player c) {
		...
		if (!c.getInventory().getItemContainer().contains(CoordinateScrolls.SEXTANT) || !c.getInventory().getItemContainer().contains(CoordinateScrolls.CHART) || !c.getInventory().getItemContainer().contains(CoordinateScrolls.WATCH)) {
	...
	public static boolean handleSextantButtons(Player c, int buttonId) {
		switch (buttonId) {
			...
			case 6952 :
				...
				return true;
			case 6959 : // Sextant give Position
