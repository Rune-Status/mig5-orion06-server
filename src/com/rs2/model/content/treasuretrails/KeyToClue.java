...
public class KeyToClue {
	...
	public static int KEY_2_DRAWERS = 2834;//used in 2 clues as not enough keys! (added for pirate clue)
		...
		switch (clueId) {
			case 3490 :
				if (player.getInventory().playerHasItem(KEY_2_DRAWERS)) {
					...
					player.getActionSender().sendMessage("Shiver me timbers!");
					return false;
				}
			case 7278 :
				if (player.getInventory().playerHasItem(KEY_2_DRAWERS)) {
	...
	public static void dropKey(Player player, Npc n) {
		switch (n.getDefinition().getId()) {
			...
			case 99 :// guard dog
			case 3582 :// guard dog
				if (!player.getInventory().playerHasItem(KEY_7_DRAWERS) && (player.getInventory().playerHasItem(7298) || player.getInventory().playerHasItem(7276))) {
			...
			case 13 :// wizard
				...
				break;
			case 182 :// pirate
				if (!player.getInventory().playerHasItem(KEY_2_DRAWERS) && player.getInventory().playerHasItem(3490)) {
                    GroundItemManager.getManager().dropItem(new GroundItem(new Item(KEY_2_DRAWERS), player, new Position(n.getPosition().getX(), n.getPosition().getY(), n.getPosition().getZ())));
				}
				break;	
			case 3246 :// barbarian
