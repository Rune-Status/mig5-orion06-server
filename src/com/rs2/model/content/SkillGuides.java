...
public class SkillGuides {
	...
	private void optionTab(String title, String currentTab, String op1, String op2, String op3, String op4, String op5, String op6, String op7, String op8, String op9, String op10, String op11, String op12, String op13) {
		...
		String[] menuTitles = {op1, op2, op3, op4, op5, op6, op7, op8, op9, op10, op11, op12, op13};
		/*for (int i : interfaceChilds)
			player.getActionSender().sendFrame171(0, i);*/
		for (int i = 0; i < interfaceChilds.length; i++)
			player.getActionSender().sendFrame171((menuTitles[i] == "" ? 1 : 0), interfaceChilds[i]);
	...
	public void runecraftingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("70", "3 Fire runes per essence", 554, 19);
			menuLine("74", "2 Chaos runes per essence", 562, 20);
			menuLine("76", "5 Water runes per essence", 555, 21);
			menuLine("77", "8 Air runes per essence", 556, 22);
			menuLine("78", "4 Earth runes per essence", 557, 23);
	...
	public void craftingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("72", "Dragonstone Necklace", 1664, 29);
			menuLine("80", "Dragonstone Amulet", 1683, 30);
			menuLine("82", "Onyx Necklace", 6577, 31);
			menuLine("90", "Onyx Amulet", 6579, 32);
	...
	public void slayerComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("60", "Aberrant Specter", 4144, 13);
	...
	public void smithingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("13", type + " Claws(After Death Plateau) - 2 Bars", 3095, 19);
			...
			menuLine("35", "Cannonballs - 1 Bar makes 4", 2, 10);
			menuLine("36", type + " Longsword - 2 Bars", 1295, 11);
			menuLine("36", type + " Studs - 1 Bar", 2370, 12);
			menuLine("37", type + " Full Helm - 2 Bars", 1157, 13);
			menuLine("37", type + " Throwing Knife", 865, 14);
			menuLine("38", type + " Square Shield - 2 Bars", 1177, 15);
			menuLine("39", type + " Warhammer - 3 Bars", 1339, 16);
			menuLine("40", type + " Battleaxe - 3 Bars", 1365, 17);
			menuLine("41", type + " Chainbody - 3 Bars", 1105, 18);
			menuLine("42", type + " Kiteshield - 3 Bars", 1193, 19);
			menuLine("43", type + " Claws(After Death Plateau) - 2 Bars", 3097, 20);
			menuLine("44", type + " Two-Handed Sword - 3 Bars", 1311, 21);
			menuLine("46", type + " Platelegs - 3 Bars", 1069, 22);
			menuLine("46", type + " Plateskirt - 3 Bars", 1083, 23);
			menuLine("48", type + " Platebody - 5 Bars", 1119, 24);
	...
	public void farmingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			//menuLine("53", "Bittercap Mushroom", 5282, 0);
			menuLine("53", "Bittercap Mushroom", 6004, 0);
			menuLine("55", "Cactus", 6016, 1);
			//menuLine("63", "Belladonna", 5281, 2);
			menuLine("63", "Belladonna", 2398, 2);
			menuLine("72", "Calquat Tree", 5980, 3);
			menuLine("83", "Spirit Tree", 6063, 4);
