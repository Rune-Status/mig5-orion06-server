...
import com.rs2.cache.obj.ObjectDefinitionParser;
...
public class ObjectLoader implements LandscapeListener, ObjectDefinitionListener {
	...
	public void load() throws IOException, InvalidCacheException {
		...
		try {
			...
			ObjectDefinitionParser.loadLocDat();
			logger.info("Loaded " + GameObjectData.definitions.length + " object definitions.");
